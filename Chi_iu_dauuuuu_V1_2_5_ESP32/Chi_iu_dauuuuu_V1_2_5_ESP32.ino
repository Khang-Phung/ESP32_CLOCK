...
#define BLYNK_FIRMWARE_VERSION "1.2.5"
...
const unsigned int updateInterval = 100;
...
const int resolution = 12;  // Chọn độ phân giải (9 đến 12)
...
void loop() {
  ...
  if (state == BUTTON_PRESSED) {
    ...
    Program_sel++;
    if (Program_sel > 2) Program_sel = 0;
    enable_display = true;
    sound_button = true;
